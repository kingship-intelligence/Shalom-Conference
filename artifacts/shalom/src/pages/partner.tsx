            ...
            <div className="text-center lg:text-left">
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    <p className="mt-3 max-w-xl text-base leading-relaxed text-muted-foreground">
                      Help make Shalom possible through a one-time gift. Use the
                      button or search this handle directly in Cash App.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-3 text-left">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                        ...
                        reference, and whether it was personal or
                        organizational. Please do not send bank details,
                        passwords, or other sensitive payment information.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 rounded-2xl border border-white/10 bg-card/60 p-6 text-left sm:p-8">
                ...
                <p className="mt-3 text-base leading-relaxed text-muted-foreground">
                  ...
                  sponsorship details. Please send donor information only when
                  it is needed for that follow-up.
                </p>
                <a
